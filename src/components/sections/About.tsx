...
const About = () => {
  ...
  return (
    <section id="about" className="py-24 bg-[color:var(--bg)] cyber-grid-bg">
      <div className="container mx-auto px-4">
        ...
        >
          <motion.h2 
            ...
            transition={{ duration: 0.6 }}
            className="text-4xl md:text-5xl font-extrabold text-center mb-10 heading-neon"
          >
            About Me
          </motion.h2>
            ...
            >
              ...
              <div className="flex flex-wrap gap-3 md:gap-4">
                <motion.div 
                  ...
                  className="px-5 py-2.5 rounded-full transition-all duration-300 border border-[color:var(--border)] text-slate-200 bg-white/5 hover:bg-white/10"
                >
                ...
                <ul className="space-y-6">
                  <li>
                    <motion.div whileHover={{ x: 5 }} className="flex items-center space-x-4 group">
                      <div className="w-10 h-10 rounded-full bg-[linear-gradient(90deg,var(--accent),var(--accent-2))] flex items-center justify-center">
                      ...
                      <div className="text-slate-300/90 text-lg leading-snug">
                  ...
                  <li>
                    <motion.div whileHover={{ x: 5 }} className="flex items-center space-x-4 group">
                      ...
                      <span className="text-slate-300/90 text-lg">2+ Years Experience</span>
                    </motion.div>
                  </li>
                  <li>
                    <motion.div whileHover={{ x: 5 }} className="flex items-center space-x-4 group">
                      ...
                      <span className="text-slate-300/90 text-lg">8+ Projects Completed</span>
                    </motion.div>
                  </li>
                  <li>
                    <motion.div whileHover={{ x: 5 }} className="flex items-center space-x-4 group">
                      ...
                      <span className="text-slate-300/90 text-lg">Always Learning & Growing</span>
                    </motion.div>
                  </li>
                </ul>
              </div>
